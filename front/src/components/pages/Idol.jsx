...
export default class Idol extends Component {
  ...
  componentDidMount() {
    client.get("/categories?slug=idol")
      .then(cat => {
    ...
    return (
      <>
        {this.state.isLoading ? 
          <Loading/> :
          <CategoryTop catId={this.state.catId} category="アイドル" recommendedPosts={this.state.parentPosts} newestPosts={this.state.childPosts} freePosts={this.state.freePosts} />
        }
      </>
    )
  }
