...
export default class Variety extends Component {
  ...
  componentDidMount() {
    client.get("/categories?slug=variety")
      .then(cat => {
    ...
    return (
      <>
        {this.state.isLoading ? 
          <Loading/> :
          <CategoryTop catId={this.state.catId} category="バラエティ" recommendedPosts={this.state.parentPosts} newestPosts={this.state.childPosts} freePosts={this.state.freePosts} />
        }
      </>
    )
  }
